...
function trafficLight(posX, posZ, rotY){
	...
	this.greenLight = new THREE.Mesh(BOX, 
		new THREE.MeshBasicMaterial({color: TRAFFIC_LIGHT_STATES.GREEN.COLOR_OFF}));
	...
	this.yellowLight = new THREE.Mesh(BOX, 
		new THREE.MeshBasicMaterial({color: TRAFFIC_LIGHT_STATES.YELLOW.COLOR_OFF}));
	this.yellowLight.scale.x = 0.4;
	this.yellowLight.scale.y = 0.15;
	this.yellowLight.scale.z = 0.4;
	this.yellowLight.position.z = 0.5;

	this.redLight = new THREE.Mesh(BOX, 
