...
function CrossroadStreet(crossroadRadius, roadLength){
	...
	const lenFromTrafficLight = roadLength - crossroadRadius;
	const streetCenter = crossroadRadius + lenFromTrafficLight/2;
   
	//creates the central square of the crossroad
	this.center = new THREE.Mesh( box, streetMesh);
	this.center.scale.y = 0.1;
	this.center.scale.z = crossroadRadius*2;
	this.center.scale.x = crossroadRadius*2;
	...
	this.streetES.position.z = crossroadRadius/2;
	this.streetEN = this.streetSW.clone();
	this.streetEN.rotation.y = ANGLE_90;
	this.streetEN.position.z = -crossroadRadius/2;
	...
	this.sidewalkES.position.z = crossroadRadius + 1.4;
	this.sidewalkEN = this.sidewalkSW.clone();
	this.sidewalkEN.rotation.y = ANGLE_90;
	this.sidewalkEN.position.z = -(crossroadRadius + 1.4);
